...
class Trainer():
    ...
    def _create_optimizer(self):
        ...
        resnet_params = set(self.model.resnet152.parameters())
        ...
        params = (get_weight_decay_params(self.model.bert.named_parameters()) + get_weight_decay_params(self.model.resnet152.named_parameters()))
